...
\date[2019]{Московский физико-технический институт\\28 ноября 2019 г.}
\begin{document}
\input{defs}
\begin{frame}
  \titlepage
...
\begin{frame}[noframenumbering]
\frametitle{Иллюстративный пример}
\textbf{Цель эксперимента:} проверка анализируемых свойств предлагаемой модели оптимизации.\\
~\\
Модель $\mathbf{f}$ --- ансамбль трех моделей:
\begin{enumerate}
...
Рассматривалось поведение оптимизируемой функции при калибровке $\lamT, \lamCL$.
\end{frame}

\begin{frame}
\frametitle{Эксперимент при $\lamT \ll 1, \lamCL \ll 1$}
\begin{center}
\includegraphics[width=0.8\textwidth]{slide_plots/plot_0_2overfit.png}
\end{center}
\end{frame}


\begin{frame}
\frametitle{Эксперимент при $\lamT \ll 1, \lamCL \gg 1$}
\begin{center}
\includegraphics[width=0.8\textwidth]{slide_plots/plot_0_2kld.png}
\end{center}
\end{frame}


\begin{frame}
\frametitle{Эксперимент при $\lamT \gg 1, \lamCL \ll 1$}
\begin{center}
\includegraphics[width=0.8\textwidth]{slide_plots/plot_10overfit.png}
\end{center}
\end{frame}


\begin{frame}
\frametitle{Эксперимент при $\lamT \gg 1, \lamCL \gg 1$}
\begin{center}
\includegraphics[width=0.8\textwidth]{slide_plots/plot_10kld.png}
\end{center}
\end{frame}


\begin{frame}
\frametitle{Эксперимент при $\lamT = 1, \lamCL = 1$}
\begin{center}
\includegraphics[width=0.8\textwidth]{slide_plots/plot_1elbo.png}
\end{center}
\end{frame}


\begin{frame}{Эксперимент по выбору моделей}
\tiny
\begin{table}[htbp!]
\begin{tabular}{ | p{1.5cm} | p{1.25cm} | p{1.25cm} | p{1.25cm} | p{1.25cm} | p{1.25cm} | p{1.25cm} |}

\hline
&\multicolumn{6}{|c|}{Алгоритмы}  \\
\hline
Выборка $\mathfrak{D}$ & ML & ML+VAL & MAP+VAL & Var+SGD & Var+Lang & Var+Norm \\
\hline
\multicolumn{7}{|c|}{Результаты, RMSE/Accuracy}  \\

\hline
{ Boston,  1  слой} & 8,1  $\pm$ 2,0 & 5,9 $\pm$ 0,7 & 5,2 $\pm$ 0,6 & $\mathbf{3,7 \pm 0,2}$ & 6,7 $\pm$ 0,7 & 5,0 $\pm$ 0,4 \\
\hline
...
\hline
MNIST & 0,985 $\pm$ 0,002 & 0,984 $\pm$ 0,002 & $\mathbf{0,986 }\pm \mathbf{0,002}$ & 0,914 $\pm$ 0,005 & 0,979 $\pm$ 0,003 & 0,971 $\pm$ 0,001 \\
\hline

\multicolumn{7}{|c|}{Результаты, $\textnormal{RMSE/Accuracy}_{0,5}$}  \\
\hline
{ Boston,  1  слой} & 43,9  $\pm$ 9,4 & 18,6 $\pm$ 2,0 &  15,8 $\pm$ 2,3 & $\mathbf{11,9}\pm \mathbf{ 1,1}$ & 20,3 $\pm$ 3,1 & 18,2 $\pm$ 3,3 \\
\hline
Boston, 3 слоя & 23,4 $\pm$ 4,9 & 18,7 $\pm$ 2,8 & 18,3 $\pm$ 3,0 & \bf 9,0 $\pm$ 0,7 & 14,5 $\pm$ 2,6 &  15,2 $\pm$ 2,7 \\
\hline
Protein & 19,5 $\pm$ 0,3 & 18,5 $\pm$ 0,5 & 18,6 $\pm$ 0,3 & $\mathbf{16,7 }\pm \mathbf{ 0,3}$ & 19,3 $\pm$ 0,6 & 19,7 $\pm$ 3,7  \\
\hline
MSD & 178,3 $\pm$ 0,8 & $\mathbf{121,3 }\pm \mathbf{ 4,5}$ & 123,7 $\pm$ 2,5 & 175,8 $\pm$ 1,0 & 203,8 $\pm$ 1,4 & 292,0 $\pm$ 2,0 \\
\hline
MNIST & 0,931 $\pm$ 0,004 & 0,929 $\pm$ 0,006 & $\mathbf{0,934 }\pm \mathbf{ 0,007}$ & 0,857 $\pm$ 0,007 & 0,919 $\pm$ 0,008 & 0,916 $\pm$ 0,004 \\
\hline


\multicolumn{7}{|c|}{Результаты, $\textnormal{RMSE/Accuracy}_{1,0}$}  \\
\hline
{ Boston,  1  слой} & 120,9 $\pm$ 33,4 & 42,5 $\pm$ 6,3 & 32,5 $\pm$ 6,0 & $\mathbf{25,7 }\pm \mathbf{ 3,2}$ & 42,4 $\pm$ 5,7 & 41,3 $\pm$ 6,3  \\
\hline
Boston, 3 слоя & 46,1 $\pm$ 15,8 & 40,5 $\pm$ 5,3 & 38,6 $\pm$ 8,0 & \bf 16,5 $\pm$ 2,5 & 30,4 $\pm$ 7,9 & 26,2 $\pm$ 6,9 \\
\hline
Protein & 37,0 $\pm$ 0,8 & 34,4 $\pm$ 1,1 & 35,0 $\pm$ 1,0 & $\mathbf{30,6 }\pm \mathbf{ 0,6}$ & 36,6 $\pm$ 1,1 & 35,0 $\pm$ 8,1 \\
\hline
MSD & 319,6 $\pm$ 1,4 & $\mathbf{217,5 }\pm \mathbf{ 8,2}$ & 221,9 $\pm$ 4,2 & 314,8 $\pm$ 1,8 & 363,7 $\pm$ 1,9 & 521,6 $\pm$ 3,1  \\
\hline
MNIST & $\mathbf{0,814 }\pm \mathbf{ 0,010 }$& 0,808 $\pm$ 0,010 &  0,812 $\pm$ 0,008 & 0,772 $\pm$ 0,010 & 0,802 $\pm$ 0,009 & 0,800 $\pm$ 0,009 \\
\hline
...
\begin{frame}{Выбор структуры модели: число параметров в модели}
\begin{table}[htbp!]
\begin{tabular}{| c | c |}
\hline
Метод выбора структуры & Число параметров \\ \hline
Случайный поиск & 1.3M $\pm$ 0.8M \\ \hline
Softmax-суперсеть & 3M $\pm$ 0.0M \\ \hline
Gumbel-Softmax-суперсеть & 1.5M $\pm$ 0.4M \\ \hline
Предложенный метод & 0.2M $\pm$ 0.1M \\ \hline
\end{tabular}
\end{table}
Результаты были округлены до десятой миллиона.
\end{frame}

\begin{frame}{Выбор структуры модели: устойчивость моделей при добавлении шума в выборку}
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{noise.pdf}
\end{figure}
\end{frame}


\begin{frame}{Выбор структуры модели:  устойчивость моделей при добавлении шума в параметры}

\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{params.pdf}
\end{figure}
\end{frame}
