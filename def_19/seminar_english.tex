...
An example of structure parameter $\boldsymbol{\gamma}$ restrictions, $|\boldsymbol{\gamma}| = 3$.
\begin{figure}
...
Every point in simplex defines a model.
...
\vspace{-1cm}
  \centering    
 \subfloat[]{\includegraphics[width=0.45\textwidth]{slide_plots/evidence_en.pdf}} 
